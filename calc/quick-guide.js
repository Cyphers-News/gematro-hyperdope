...
{ id: "breakdown", label: "🧮 Breakdown", html:
	...
	+ '<li>Found under <span class="qgBold">"Show Only Matching"</span> in the Matches tab.</li>'
	+ '</ul>'
...
{ id: "coderain", label: "🌊 Code Rain", html:
	...
	+ '<ul>'
	+ '<li><span class="qgBold">Click</span> the toggle at the far right of the top menu to cycle through five styles, in order:'
	+ ' <span class="qgBold">Matrix</span> &#10148; <span class="qgBold">Off</span> &#10148;'
	+ ' <span class="qgBold">Decode</span> &#10148; <span class="qgBold">Retro</span> &#10148;'
	+ ' <span class="qgBold">CCRU</span> &#10148; back to <span class="qgBold">Matrix</span>.</li>'
	+ '<li><span class="qgBold">Matrix</span> - the film\'s white-headed green columns on solid black. The default.</li>'
	+ '<li><span class="qgBold">Decode</span> - a subtler multi-script glyph rain that blends into the page background instead of sitting on its own black backdrop.</li>'
	+ '<li><span class="qgBold">Retro</span> - the original rain style, coloured by the sliders below.</li>'
	+ '<li><span class="qgBold">CCRU</span> - a dense neon grid with its own committed colour.</li>'
	+ '<li>Every style mixes Latin letters and digits with katakana, Hebrew, Greek and Cyrillic glyphs.</li>'
	+ '</ul>'

	+ '<p class="qgMedium">Tuning It (the switchers)</p>'
	+ '<ul>'
	+ '<li><span class="qgBold">Hover</span> the toggle (long-press on touch) to open the panel underneath it.</li>'
...
{ id: "options", label: "⚙ Settings", html:
	'<p class="qgNote">There is no Options tab any more. What it held is now in two places:'
	+ ' the sliders icon in the top left corner for anything that changes what you see,'
	+ ' and the Matches tab for everything else.</p>'

	+ '<p class="qgMedium">Sliders icon (top left)</p>'
	+ '<ul>'
	...
	+ '<li><span class="qgBold">"Show in Focus Mode"</span> - which of these stay on screen in Focus Mode</li>'
	+ '</ul>'

	+ '<p class="qgMedium">Matches tab</p>'
	+ '<ul>'
	...
	+ '<li><span class="qgBold">"Gematria Calculation"</span> - Regular, Multiply, or Reverse Multiply</li>'
	...
	+ '<li><span class="qgBold">"Clear DB Query"</span> and <span class="qgBold">"Unload Database"</span> - clear the current query, or drop the loaded database</li>'
	+ '<li><span class="qgBold">"Switch Ciphers (CSV)"</span> - re-enable the saved cypher selection when importing history</li>'
	+ '<li><span class="qgBold">"Clear History"</span> - empty the history table</li>'
	+ '</ul>'
},
