...
function toggleEncodingMenu(updateEncMenu = false, clearValues = false) {
	if (!encodingMenuOpened || updateEncMenu == true) {
		...
		o += '<td><input type="text" autocomplete="off" placeholder="a,b,c,d,e,f" value="'+escHtml(prevAlphStr)+'" class="colSlider" id="encAlphabetBox" style="width: 300px;" oninput="encPrevAlphStr = document.getElementById(&quot;encAlphabetBox&quot;).value"'+SylParamChkState+'></td>'
		o += '</tr><tr>'
		o += '<td><span class="colLabelSmall">Vowels</span></td>'
		o += '<td><input type="text" autocomplete="off" placeholder="a,e,i,o,u,y" value="'+escHtml(prevVowStr)+'" class="colSlider" id="encVowelsBox" style="width: 300px;" oninput="encPrevVowStr = document.getElementById(&quot;encVowelsBox&quot;).value"'+SylParamChkState+'></td>'
		o += '</tr><tr>'
		o += '<td><span class="colLabelSmall">Exclude</span></td>'
		o += '<td><input type="text" autocomplete="off" placeholder="q,z,j,x,k,w,v,f" value="'+escHtml(prevExcStr)+'" class="colSlider" id="encExcludeBox" style="width: 300px;" oninput="encPrevExcLetStr = document.getElementById(&quot;encExcludeBox&quot;).value"'+SylParamChkState+'></td>'
		o += '</tr>'
		o += '</table>'
